error id: file://<WORKSPACE>/src/main/scala/example/Vorlesung.scala:[3156..3156) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/example/Vorlesung.scala", "/*
...
def concatenate[A](acc : A, elem : String) : String = acc + elem.toString()

def 
    ")
file://<WORKSPACE>/src/main/scala/example/Vorlesung.scala
file://<WORKSPACE>/src/main/scala/example/Vorlesung.scala:118: error: expected identifier; obtained eof
